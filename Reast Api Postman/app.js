...
const url = "mongodb+srv://vivektank:vivektank@cluster0.pqvunzi.mongodb.net/?retryWrites=true&w=majority"

mongoose.connect(url).then(result => { console.log("db connect");}).catch(err => {console.log(err);})
...
app.listen(port, () => { console.log("sever is runng");})